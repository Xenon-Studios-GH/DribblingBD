...
<div class="space-y-3">
    ...
    @php
        ...
        $params = http_build_query(['tab' => 'stock', 'period' => $period, 'label' => $r->period_label]);
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex items-center gap-2 ml-4">
                    <button data-view-url="{{ route('admin.reports.details') }}?tab=stock&period={{ $period }}&label={{ $r->period_label }}"
