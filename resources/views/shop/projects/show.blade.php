                ...
                <div class="group bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
                    <a href="{{ shop_project_url($related) }}" class="block">
                        <div class="aspect-square bg-gray-100 overflow-hidden">
                            ...
                            @if($firstImage)
                            <img src="{{ asset('storage/' . $firstImage->image_path) }}" alt="{{ $related->product->product_name }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                            @else
