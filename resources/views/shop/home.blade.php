            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
                @foreach ($newArrivals as $product)
                    <div class="group rounded-2xl bg-white border border-gray-200 hover:border-[#E85D2C]/30 hover:shadow-lg hover:shadow-orange-500/5 transition-all duration-300 overflow-hidden" x-data="{ added: false }">
                        <a href="{{ route('shop.products.show', $product->product_code) }}" class="block aspect-[4/5] bg-gradient-to-br from-gray-100 to-gray-200 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="text-center">
                    ...
                    <h4 class="mt-3 text-sm font-semibold text-gray-900">Free Shipping</h4>
                    <p class="mt-0.5 text-xs text-gray-500">On orders over ৳3,000</p>
                </div>
                <div class="text-center">
                    <div class="w-12 h-12 mx-auto rounded-xl bg-orange-50 flex items-center justify-center">
                        <i class="fas fa-truck w-6 h-6 text-[#E85D2C]"></i>
                    </div>
                    <h4 class="mt-3 text-sm font-semibold text-gray-900">72 Hours Home Delivery</h4>
                    <p class="mt-0.5 text-xs text-gray-500">Fast delivery at your doorstep</p>
                </div>
                <div class="text-center">
                    <div class="w-12 h-12 mx-auto rounded-xl bg-orange-50 flex items-center justify-center">
                        <i class="fas fa-shield-alt w-6 h-6 text-[#E85D2C]"></i>
                    </div>
                    <h4 class="mt-3 text-sm font-semibold text-gray-900">Premium Quality</h4>
                    <p class="mt-0.5 text-xs text-gray-500">100% authentic fabric</p>
                </div>
                <div class="text-center">
                    <div class="w-12 h-12 mx-auto rounded-xl bg-orange-50 flex items-center justify-center">
                        <i class="fas fa-crosshairs w-6 h-6 text-[#E85D2C]"></i>
                    </div>
                    <h4 class="mt-3 text-sm font-semibold text-gray-900">24/7 Support</h4>
                    <p class="mt-0.5 text-xs text-gray-500">Dedicated customer service</p>
                </div>
            </div>
        </div>
    </section>
