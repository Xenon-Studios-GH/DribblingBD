    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between min-h-16 lg:min-h-20">
            ...
            <a href="/" class="flex-shrink-0">
                <img src="{{ asset('images/logo.png') }}" alt="DribblingBD" class="h-12 sm:h-16 w-auto">
            </a>
            ...
            <div class="flex items-center gap-1 sm:gap-2">
                @auth
                    ...
                    <div class="flex items-center gap-1 sm:gap-2 ml-2">
                        @if (Auth::user()->client)
                            <a href="{{ route('shop.profile.index', Auth::user()->client->usercode) }}" class="flex items-center justify-center w-10 h-10 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-100 lg:inline-flex lg:w-auto lg:h-auto lg:gap-1.5 lg:px-4 lg:py-2 lg:rounded-xl lg:bg-[#E85D2C] lg:text-white lg:hover:bg-[#d14d1f]">
                                <i class="fas fa-user w-5 h-5"></i>
                                <span class="hidden lg:inline text-sm font-medium">Profile</span>
                            </a>
                        @else
                            <a href="{{ admin_route('dashboard') }}" class="flex items-center justify-center w-10 h-10 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-100 lg:inline-flex lg:w-auto lg:h-auto lg:gap-1.5 lg:px-4 lg:py-2 lg:rounded-xl lg:bg-gray-900 lg:text-white lg:hover:bg-gray-800">
