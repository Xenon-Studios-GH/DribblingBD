        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-12">
            <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                <div>
                    ...
                    <p class="text-sm text-gray-400 mt-1">Get exclusive jersey drops, offers, and 10% off your first order.</p>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2.5">
                    ...
                    <li><a href="{{ route('shop.products.index') }}" class="text-sm text-gray-400 hover:text-white transition-colors">Club Kits</a></li>
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2.5">
                    ...
                    <li><a href="#" class="text-sm text-gray-400 hover:text-white transition-colors">FAQs</a></li>
                    <li><a href="#" class="text-sm text-gray-400 hover:text-white transition-colors">Size Guide</a></li>
                    <li><a href="#" class="text-sm text-gray-400 hover:text-white transition-colors">Shipping & Delivery</a></li>
                    <li><a href="#" class="text-sm text-gray-400 hover:text-white transition-colors">72 Hours Home Delivery</a></li>
                </ul>
            </div>
