<div id="toast" role="alert" aria-live="polite" style="display:none; position:fixed; top:24px; right:24px; left:24px; z-index:99999; font-family:system-ui,-apple-system,sans-serif;">
    <div id="toast-inner" style="display:flex; align-items:stretch; max-width:420px; margin-left:auto; border-radius:16px; background:rgba(255,255,255,0.95); backdrop-filter:blur(20px); -webkit-backdrop-filter:blur(20px); box-shadow:0 20px 60px rgba(0,0,0,0.15), 0 0 0 1px rgba(0,0,0,0.05); overflow:hidden; transform:translateX(120%) scale(0.9); transition:all 0.5s cubic-bezier(0.34,1.56,0.64,1);">
        ...
        <div style="display:flex; align-items:center; gap:14px; padding:16px 18px; flex:1;">
            ...
            <button onclick="document.getElementById('toast').style.display='none'" aria-label="Close notification" style="width:28px; height:28px; border-radius:8px; border:none; background:transparent; color:#94a3b8; cursor:pointer; display:flex; align-items:center; justify-content:center; flex-shrink:0; transition:all 0.2s; font-size:14px; padding:0;" onmouseover="this.style.background='#f1f5f9'; this.style.color='#475569'" onmouseout="this.style.background='transparent'; this.style.color='#94a3b8'">✕</button>
        </div>
