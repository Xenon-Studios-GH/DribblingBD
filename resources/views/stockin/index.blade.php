                ...
                <template x-if="selected">
                    <div class="space-y-4 pt-2 border-t border-[#232A36]">
                        ...
                        <div>
                            ...
                            <input type="text" x-model="note" placeholder="e.g. Supplier delivery, restock reason..." class="w-full rounded-xl border border-[#232A36] bg-[#0F1117] px-4 py-2.5 text-sm text-[#E6EDF3] focus:border-[#3B82F6] focus:outline-none">
                        </div>
