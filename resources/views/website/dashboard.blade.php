<x-layouts.app title="Website Dashboard">
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <x-card>
                <p class="text-sm text-[#94A3B8]">Total Projects</p>
        ...
        <x-card>
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-semibold text-[#E6EDF3]">Projects by Category</h2>
            </div>
            <div class="space-y-2">
                ...
                <div class="flex items-center justify-between py-2 border-b border-[#232A36] last:border-0">
                    ...
                    <span class="text-sm font-medium text-[#94A3B8]">{{ $cat->projects_count }} projects</span>
                </div>
                @empty
