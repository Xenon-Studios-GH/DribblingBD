                ...
                <div class="space-y-6">
                    ...
                    <x-card>
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="text-sm font-semibold text-[#E6EDF3]">Shipping Rates & Fees</h3>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                            ...
                            <div>
                                <label class="mb-1 block text-xs text-[#94A3B8]">DTF Fee per Item (৳)</label>
                                <input name="dtf_fee" value="{{ $settings['dtf_fee'] ?? '200' }}" class="w-full rounded-lg border border-[#232A36] bg-[#0F1117] px-3 py-2 text-xs text-[#E6EDF3]">
                            </div>
                        </div>
                    </x-card>
