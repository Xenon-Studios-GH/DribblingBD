...
const LOCAL_PRODUCTS = [
  ...
  { id: 13, name: 'England 2026 Home Red', category: ['wc26'], price: 1150, oldPrice: 1500, badge: 'Classic', rating: 4.8, reviews: 245, img: '/products/england-2627.webp', desc: 'The England 2026 Home Jersey features the iconic Three Lions design.', features: ['Three Lions embroidered crest', 'Nike Dri-Fit technology', 'Heritage red colorway', 'Modern tapered fit'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 14, name: 'Bayern Munich 26/27', category: ['clubs'], price: 1050, oldPrice: 1400, badge: 'Bestseller', rating: 4.7, reviews: 189, img: '/products/bayern-2627.webp', desc: 'The Bayern Munich 26/27 Home Jersey represents German excellence.', features: ['Classic red and white design', 'Adidas performance technology', 'FC Bayern embossed crest', 'Sustainable recycled materials'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 15, name: 'Netherlands 26/27 Orange', category: ['wc26'], price: 1100, oldPrice: 1450, badge: 'New', rating: 4.6, reviews: 167, img: '/products/netherlands-2627.webp', desc: 'The Netherlands 26/27 Home Jersey showcases the famous orange design.', features: ['Vibrant orange colorway', 'Nike Aerostream technology', 'KNVB embroidered crest', 'Dynamic fit construction'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 16, name: 'Chelsea 26/27 Blue', category: ['clubs'], price: 980, oldPrice: 1300, badge: 'Popular', rating: 4.5, reviews: 298, img: '/products/chelsea-2627.webp', desc: 'The Chelsea 26/27 Home Jersey features the iconic blue design.', features: ['Classic Chelsea blue', 'Nike Dri-Fit ADV technology', 'Embroided club crest', 'Pensioner detail inside'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 17, name: 'Spain 26/27 Red Fury', category: ['wc26'], price: 1080, oldPrice: 1420, badge: 'Premium', rating: 4.7, reviews: 134, img: '/products/spain-2627.webp', desc: 'The Spain 26/27 Home Jersey celebrates La Roja champion legacy.', features: ['Classic red design', 'Adidas AEROREADY fabric', 'Federacion crest detail', 'Champions badge included'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 18, name: 'Juventus 26/27 Black', category: ['clubs'], price: 950, oldPrice: 1250, badge: 'New', rating: 4.6, reviews: 156, img: '/products/juventus-2627.webp', desc: 'The Juventus 26/27 Home Jersey combines tradition with innovation.', features: [' iconic black and white stripes', 'PUMA dryCELL technology', 'J club crest', 'Unique collar design'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 19, name: 'Italy 26/27 Azzurri', category: ['wc26'], price: 1150, oldPrice: 1550, badge: 'Heritage', rating: 4.8, reviews: 178, img: '/products/italy-2627.webp', desc: 'The Italy 26/27 Home Jersey represents the Azzurri pride.', features: ['Classic azzurro blue', 'PUMA evoKNIT technology', 'FIGC embroidered crest', 'Four-star championship detail'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 20, name: 'Arsenal 26/27 Red', category: ['clubs'], price: 990, oldPrice: 1320, badge: 'Classic', rating: 4.5, reviews: 267, img: '/products/arsenal-2627.webp', desc: 'The Arsenal 26/27 Home Jersey captures the Gunners spirit.', features: ['Traditional cannon design', 'Adidas HEAT.RDY technology', 'Club crest embroidery', 'Cannon detail inside collar'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 21, name: 'South Korea 26/27 Red', category: ['wc26'], price: 1000, oldPrice: 1350, badge: 'Exclusive', rating: 4.7, reviews: 89, img: '/products/skorea-2627.webp', desc: 'The South Korea 2026 Home Jersey features the Taegeuk design.', features: ['Taegeuk symbol detail', 'Nike Dri-Fit technology', 'KFA embroidered crest', 'Taegeuk coloring throughout'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 22, name: 'Inter Milan 26/27', category: ['clubs'], price: 970, oldPrice: 1280, badge: 'Trending', rating: 4.6, reviews: 145, img: '/products/inter-2627.webp', desc: 'The Inter Milan 26/27 Home Jersey shows the iconic Nerazzurri stripes.', features: ['Bold blue and black stripes', 'PUMA performance technology', 'Inter club crest', 'Sunburst detail on back'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 23, name: 'Belgium 26/27 Red', category: ['wc26'], price: 1050, oldPrice: 1400, badge: 'Popular', rating: 4.6, reviews: 123, img: '/products/belgium-2627.webp', desc: 'The Belgium 2026 Home Jersey features the Red Devils pride.', features: ['Vibrant red design', 'Adidas AEROREADY fabric', 'KBVB crest detail', 'Golden Devils badge'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 24, name: 'Tottenham 26/27 White', category: ['clubs'], price: 960, oldPrice: 1280, badge: 'New', rating: 4.5, reviews: 198, img: '/products/tottenham-2627.webp', desc: 'The Tottenham Hotspur 26/27 Home Jersey represents North London pride.', features: ['Classic white design', 'Nike Dri-Fit technology', 'Spurs crest embroidery', 'cockerel detail inside'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 25, name: 'Cricket Bangladesh Tigers', category: ['cricket'], price: 850, oldPrice: 1100, badge: 'New', rating: 4.8, reviews: 89, img: '/products/bangladesh-cricket.webp', desc: 'Official Bangladesh Tigers cricket jersey with tiger motif.', features: ['Bangladesh tiger design', 'Moisture-wicking fabric', 'Official BCB crest', 'Tigers branding'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 26, name: 'Cricket India Blue', category: ['cricket'], price: 900, oldPrice: 1200, badge: 'Popular', rating: 4.7, reviews: 156, img: '/products/india-cricket.webp', desc: 'Official India cricket jersey in classic blue.', features: ['Team India blue design', 'BCCI official crest', 'Performance fit', 'Men in Blue branding'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 27, name: 'Cricket Australia Gold', category: ['cricket'], price: 950, oldPrice: 1250, badge: 'Bestseller', rating: 4.9, reviews: 234, img: '/products/australia-cricket.webp', desc: 'Official Australia cricket jersey with indigenous design.', features: ['Indigenous artwork design', 'Cricket Australia crest', 'Aus jersey technology', 'Baggy Green inspired'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
  { id: 28, name: 'Cricket England Whites', category: ['cricket'], price: 880, oldPrice: 1150, badge: 'Classic', rating: 4.6, reviews: 112, img: '/products/england-cricket.webp', desc: 'Classic England Test cricket jersey.', features: ['Traditional white design', 'ECB official crest', 'Ashes badge detail', 'Heritage styling'], active: true, images: [], sizes: ['S', 'M', 'L', 'XL', 'XXL'] },
];
...
const CATEGORIES = [
  ...
  { id: 'cricket', name: 'Cricket', icon: 'fa-solid fa-cricket-bat-ball' },
