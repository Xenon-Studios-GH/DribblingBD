...
class SeoController extends Controller
{
    ...
    public function index(Request $request, SeoDashboardService $dashboardService)
    {
        ...
        return view('seo.index', compact('seoMetas', 'counts', 'healthScore', 'stats', 'alerts'));
    }
    ...
    public function update(Request $request, SeoMeta $seoMeta)
    {
        ...
        if (!empty($validated['meta_title'])) {
            $existing = \App\Models\SeoMeta::where('meta_title', $validated['meta_title'])
                ->where('id', '!=', $seoMeta->id)
                ->exists();
            if ($existing) {
                return back()->withErrors(['meta_title' => 'This meta title already exists. Please use a unique title.'])->withInput();
            }
        }
